...
# --- НАСТРОЙКИ ---
INPUT_FILE = r'C:\Users\Hasee\Documents\AKSON\Order_recognition\order_recognition\data\Материалы с признаками.xlsx'
OUTPUT_FILE = 'order_recognition/core/param_mapper.py'
HIERARCHY_LEVEL_FOR_CATEGORY = 'Иерархия 2 уровень' 
COLUMN_WITH_FULL_NAME = 'Материал название'
NULL_VALUE = "##"
