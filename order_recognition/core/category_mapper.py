...
# Это наш "Единый Источник Правды"
# Ключ - каноническое имя (base_name), которое мы будем использовать везде.
# Значение - список ключевых слов, по которым мы определяем эту категорию.
# Словарь сделан на основе твоего отчета.
CATEGORY_MAP = {
...
# Список категорий из cat1, которые мы БУДЕМ обрабатывать. Остальные игнорируем.
VALID_CAT1 = [
